...
BATCH_SIZE=100
NUM_SAMPLES=12000
OUTPUT_DIR='/proj/berzelius-2024-90/users/x_liumi/langchain-image-query/data/txt_db/cele_adv_minigpt4_byminigpt4_1'
IMAGE_PATH='/proj/berzelius-2024-90/users/x_liumi/langchain-image-query/data/attack/cele_adv_minigpt4_1'
...
torchrun --nproc_per_node=$NUM_GPUS --nnodes=1 \
    ...
    /proj/berzelius-2024-90/users/x_liumi/langchain-image-query/models/MiniGPT-4/minigpt4_vqa_parallel.py \
        ...
        --cfg-path $CFG_PATH \
        --queries "${QUERIES[@]}" \
        > vqa_cele_parallel_adv1.log 2>&1
