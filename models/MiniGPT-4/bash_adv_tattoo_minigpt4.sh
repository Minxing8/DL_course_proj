...
# NUM_SAMPLES=2000         
# STEPS=300              
# OUTPUT_DIR='/proj/berzelius-2024-90/users/x_liumi/langchain-image-query/data/attack/tattoo_adv_minigpt4'
...
OUTPUT_DIR='/proj/berzelius-2024-90/users/x_liumi/langchain-image-query/data/attack_new/tattoo_adv_minigpt4'
...
CFG_PATH='./eval_configs/minigpt4_eval.yaml'
GPU_ID=0
# CSV_PATH='/proj/berzelius-2024-90/users/x_liumi/langchain-image-query/data/attack/tattoo_minigpt4_mapping.csv'
