...
BATCH_SIZE=100
NUM_SAMPLES=2000
OUTPUT_DIR='/proj/berzelius-2024-90/users/x_liumi/langchain-image-query/data/txt_db_new/cele_clean_minigpt4'
IMAGE_PATH='/proj/berzelius-2024-90/users/x_liumi/langchain-image-query/data/evaluate_100/cele_clean'
CFG_PATH='./eval_configs/minigpt4_eval.yaml'
GPU_ID=0  # Using one GPU
DATASET_TAG="cele_clean"
TIME_LOG="time.txt"
...
# BATCH_SIZE=100
# NUM_SAMPLES=12000
# OUTPUT_DIR='/proj/berzelius-2024-90/users/x_liumi/langchain-image-query/data/txt_db/cele_clean_minigpt4_1'
# IMAGE_PATH='/proj/berzelius-2024-90/users/x_liumi/langchain-image-query/data/images/cele_clean_1'
# CFG_PATH='./eval_configs/minigpt4_eval.yaml'
...
#     --gpu-id 0 \
#     --img_path /proj/berzelius-2024-90/users/x_liumi/langchain-image-query/data/images/cele_clean \
#     --queries "Describe the image."\
#         "Identify the person in the image and describe their outfit."\
#         "Identify the person in the image and state the location and surroundings where the person is."\
#         "Who is the person in the image and what activity is the person engaged in?"\
#         "Mention any context clues that indicate who the person is or where they are." \
#     --output_dir "/proj/berzelius-2024-90/users/x_liumi/langchain-image-query/data/txt_db/cele_clean_minigpt4" \
#     --output_name "cele_clean_minigpt4" \
#     --batch_size 500 \
#     --num_samples 12000
