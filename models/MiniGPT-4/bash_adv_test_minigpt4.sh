...
# NUM_SAMPLES=10000         
# STEPS=300              
# OUTPUT_DIR='/proj/berzelius-2024-90/users/x_liumi/langchain-image-query/data/attack/adv_test_para_minigpt4'
# IMAGE_PATH='/proj/berzelius-2024-90/users/x_liumi/langchain-image-query/data/test_img'
...
NUM_SAMPLES=12000
STEPS=300               # Align with adversarial script
OUTPUT_DIR='/proj/berzelius-2024-90/users/x_liumi/langchain-image-query/data/attack/adv_test_minigpt4'
IMAGE_PATH='/proj/berzelius-2024-90/users/x_liumi/langchain-image-query/data/test_img'
TARGET_PATH='/proj/berzelius-2024-90/users/x_liumi/langchain-image-query/data/attack/targeted_image'
CFG_PATH='./eval_configs/minigpt4_eval.yaml'
GPU_ID=0
