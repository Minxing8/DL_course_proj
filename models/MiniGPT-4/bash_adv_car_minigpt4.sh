...
# NUM_SAMPLES=2000        
# STEPS=300              
# OUTPUT_DIR='/proj/berzelius-2024-90/users/x_liumi/langchain-image-query/data/attack/car_adv_minigpt4'
# IMAGE_PATH='/proj/berzelius-2024-90/users/x_liumi/langchain-image-query/data/images/car_clean'
...
OUTPUT_DIR='/proj/berzelius-2024-90/users/x_liumi/langchain-image-query/data/attack_new/car_adv_minigpt4'
IMAGE_PATH='/proj/berzelius-2024-90/users/x_liumi/langchain-image-query/data/evaluate_100/car_clean'
TARGET_PATH='/proj/berzelius-2024-90/users/x_liumi/langchain-image-query/data/attack/target'
CFG_PATH='./eval_configs/minigpt4_eval.yaml'
GPU_ID=0
# CSV_PATH='/proj/berzelius-2024-90/users/x_liumi/langchain-image-query/data/attack/car_minigpt4_mapping.csv'  # New parameter
...
python /proj/berzelius-2024-90/users/x_liumi/langchain-image-query/models/MiniGPT-4/adv_img_minigpt4_new.py \
    --batch_size $BATCH_SIZE \
    --num_samples $NUM_SAMPLES \
    --steps $STEPS \
    --output $OUTPUT_DIR \
